...
# # Average calculation
# l_eyes 	= [int(x/len(images[:50])) for x in l_eyes]
# r_eyes 	= [int(x/len(images[:50])) for x in r_eyes]
# mouth 	= [int(0.5*x/len(images[:50])) for x in mouth]
# nose 	= [int(0.5*x/len(images[:50])) for x in nose]
